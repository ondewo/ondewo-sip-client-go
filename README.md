...
```go
import sippb "github.com/ondewo/ondewo-sip-client-go/v5/api/ondewo/sip"
```
...
> shorter spelling of the same module — `go get github.com/ondewo/ondewo-sip-client-go` names a
...
import (
    ...
    sippb "github.com/ondewo/ondewo-sip-client-go/v5/api/ondewo/sip"
    "github.com/ondewo/ondewo-sip-client-go/v5/auth"
)
...
```shell
make check_go_module_path   ## go.mod and every self-import carry the /vN that ONDEWO_SIP_VERSION implies
